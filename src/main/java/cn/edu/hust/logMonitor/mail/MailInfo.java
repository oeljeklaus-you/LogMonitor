...
public class MailInfo {
    ...
    public MailInfo(String title, String content, List<String> receiver, List<String> ccList) {
        this.mailServerHost = ZkConfigPropertyParser.getSmtpServer();
        this.userName = ZkConfigPropertyParser.getSmtpUser();
        this.userPassword = ZkConfigPropertyParser.getSmtpPwd();
        this.fromAddress = ZkConfigPropertyParser.getFromAddress();
